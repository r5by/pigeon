              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.tasks = new ArrayList<edu.utarlington.pigeon.thrift.TFullTaskId>(_list0.size);
                  edu.utarlington.pigeon.thrift.TFullTaskId _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new edu.utarlington.pigeon.thrift.TFullTaskId();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, tasksFinished_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.tasks != null) {
          oprot.writeFieldBegin(TASKS_FIELD_DESC);
          {
            ...
            for (edu.utarlington.pigeon.thrift.TFullTaskId _iter3 : struct.tasks)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetTasks()) {
          {
            ...
            for (edu.utarlington.pigeon.thrift.TFullTaskId _iter4 : struct.tasks)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.tasks = new ArrayList<edu.utarlington.pigeon.thrift.TFullTaskId>(_list5.size);
            edu.utarlington.pigeon.thrift.TFullTaskId _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new edu.utarlington.pigeon.thrift.TFullTaskId();
              _elem6.read(iprot);
