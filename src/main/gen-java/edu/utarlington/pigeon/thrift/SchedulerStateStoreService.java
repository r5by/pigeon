              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.snapshot = new HashMap<String,edu.utarlington.pigeon.thrift.TNodeState>(2*_map8.size);
                  String _key9;
                  edu.utarlington.pigeon.thrift.TNodeState _val10;
                  for (int _i11 = 0; _i11 < _map8.size; ++_i11)
                  {
                    _key9 = iprot.readString();
                    _val10 = new edu.utarlington.pigeon.thrift.TNodeState();
                    _val10.read(iprot);
                    struct.snapshot.put(_key9, _val10);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateNodeState_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.snapshot != null) {
          oprot.writeFieldBegin(SNAPSHOT_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, edu.utarlington.pigeon.thrift.TNodeState> _iter12 : struct.snapshot.entrySet())
            {
        ...
        if (struct.isSetSnapshot()) {
          {
            ...
            for (Map.Entry<String, edu.utarlington.pigeon.thrift.TNodeState> _iter13 : struct.snapshot.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.snapshot = new HashMap<String,edu.utarlington.pigeon.thrift.TNodeState>(2*_map14.size);
            String _key15;
            edu.utarlington.pigeon.thrift.TNodeState _val16;
            for (int _i17 = 0; _i17 < _map14.size; ++_i17)
            {
              _key15 = iprot.readString();
              _val16 = new edu.utarlington.pigeon.thrift.TNodeState();
              _val16.read(iprot);
              struct.snapshot.put(_key15, _val16);
            }
          }
          struct.setSnapshotIsSet(true);
        }
