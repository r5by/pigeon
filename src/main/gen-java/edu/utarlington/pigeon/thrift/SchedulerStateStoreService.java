              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.snapshot = new HashMap<String,edu.utarlington.pigeon.thrift.TNodeState>(2*_map16.size);
                  String _key17;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateNodeState_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.snapshot != null) {
          oprot.writeFieldBegin(SNAPSHOT_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, edu.utarlington.pigeon.thrift.TNodeState> _iter20 : struct.snapshot.entrySet())
            {
        ...
        if (struct.isSetSnapshot()) {
          {
            ...
            for (Map.Entry<String, edu.utarlington.pigeon.thrift.TNodeState> _iter21 : struct.snapshot.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.snapshot = new HashMap<String,edu.utarlington.pigeon.thrift.TNodeState>(2*_map22.size);
            String _key23;
