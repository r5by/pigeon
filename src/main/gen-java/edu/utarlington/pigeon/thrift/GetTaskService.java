...
public class GetTaskService {
  ...
  public interface Iface {
    ...
    public java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> getTask(java.lang.String requestId, edu.utarlington.pigeon.thrift.THostPort nodeMonitorAddress) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getTask(java.lang.String requestId, edu.utarlington.pigeon.thrift.THostPort nodeMonitorAddress, org.apache.thrift.async.AsyncMethodCallback<java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getTask(java.lang.String requestId, edu.utarlington.pigeon.thrift.THostPort nodeMonitorAddress) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> recv_getTask() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getTask_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>> {
      private java.lang.String requestId;
      private edu.utarlington.pigeon.thrift.THostPort nodeMonitorAddress;
      public getTask_call(java.lang.String requestId, edu.utarlington.pigeon.thrift.THostPort nodeMonitorAddress, org.apache.thrift.async.AsyncMethodCallback<java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> getResult() throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getTask<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getTask_args, java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>> {
      public getTask() {
        super("getTask");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>>() { 
          public void onComplete(java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> o) {
            getTask_result result = new getTask_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getTask_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class getTask_args implements org.apache.thrift.TBase<getTask_args, getTask_args._Fields>, java.io.Serializable, Cloneable, Comparable<getTask_args>   {
    ...
    public edu.utarlington.pigeon.thrift.THostPort nodeMonitorAddress; // required
    ...
    public getTask_args(
      ...
      edu.utarlington.pigeon.thrift.THostPort nodeMonitorAddress)
    {
      this();
      this.requestId = requestId;
      this.nodeMonitorAddress = nodeMonitorAddress;
    ...
    public getTask_args(getTask_args other) {
      ...
      if (other.isSetNodeMonitorAddress()) {
        this.nodeMonitorAddress = new edu.utarlington.pigeon.thrift.THostPort(other.nodeMonitorAddress);
      }
    }
    ...
    public getTask_args setRequestId(java.lang.String requestId) {
      this.requestId = requestId;
      return this;
    }
    ...
    public edu.utarlington.pigeon.thrift.THostPort getNodeMonitorAddress() {
      return this.nodeMonitorAddress;
    }

    public getTask_args setNodeMonitorAddress(edu.utarlington.pigeon.thrift.THostPort nodeMonitorAddress) {
      this.nodeMonitorAddress = nodeMonitorAddress;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case NODE_MONITOR_ADDRESS:
        if (value == null) {
          ...
          setNodeMonitorAddress((edu.utarlington.pigeon.thrift.THostPort)value);
        }
        break;
          ...
          switch (schemeField.id) {
            ...
            case 2: // NODE_MONITOR_ADDRESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.nodeMonitorAddress = new edu.utarlington.pigeon.thrift.THostPort();
  ...
  public static class getTask_result implements org.apache.thrift.TBase<getTask_result, getTask_result._Fields>, java.io.Serializable, Cloneable, Comparable<getTask_result>   {
    ...
    public java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, edu.utarlington.pigeon.thrift.TTaskLaunchSpec.class))));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public getTask_result(
      java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> success)
    {
      this();
    ...
    public getTask_result(getTask_result other) {
      if (other.isSetSuccess()) {
        java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> __this__success = new java.util.ArrayList<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>(other.success.size());
        for (edu.utarlington.pigeon.thrift.TTaskLaunchSpec other_element : other.success) {
          __this__success.add(new edu.utarlington.pigeon.thrift.TTaskLaunchSpec(other_element));
        }
    ...
    public java.util.Iterator<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(edu.utarlington.pigeon.thrift.TTaskLaunchSpec elem) {
      if (this.success == null) {
        this.success = new java.util.ArrayList<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>();
      }
      this.success.add(elem);
    }

    public java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> getSuccess() {
      return this.success;
    }

    public getTask_result setSuccess(java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>(_list0.size);
                  edu.utarlington.pigeon.thrift.TTaskLaunchSpec _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new edu.utarlington.pigeon.thrift.TTaskLaunchSpec();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getTask_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (edu.utarlington.pigeon.thrift.TTaskLaunchSpec _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (edu.utarlington.pigeon.thrift.TTaskLaunchSpec _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>(_list5.size);
            edu.utarlington.pigeon.thrift.TTaskLaunchSpec _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new edu.utarlington.pigeon.thrift.TTaskLaunchSpec();
              _elem6.read(iprot);
