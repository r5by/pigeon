...
public class GetTaskService {
  ...
  public interface Iface {
    ...
    public List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> getTask(String requestId, edu.utarlington.pigeon.thrift.THostPort nodeMonitorAddress) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getTask(String requestId, edu.utarlington.pigeon.thrift.THostPort nodeMonitorAddress, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getTask(String requestId, edu.utarlington.pigeon.thrift.THostPort nodeMonitorAddress) throws org.apache.thrift.TException
    {
    ...
    public List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> recv_getTask() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getTask_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public getTask_call(String requestId, edu.utarlington.pigeon.thrift.THostPort nodeMonitorAddress, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> getResult() throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getTask<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getTask_args, List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>> {
      public getTask() {
        super("getTask");
      }
      ...
      public AsyncMethodCallback<List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>>() { 
          public void onComplete(List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> o) {
            getTask_result result = new getTask_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getTask_args args, org.apache.thrift.async.AsyncMethodCallback<List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>> resultHandler) throws TException {
  ...
  public static class getTask_result implements org.apache.thrift.TBase<getTask_result, getTask_result._Fields>, java.io.Serializable, Cloneable, Comparable<getTask_result>   {
    ...
    public List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> success; // required
    ...
    public getTask_result(
      List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> success)
    {
      this();
    ...
    public getTask_result(getTask_result other) {
      if (other.isSetSuccess()) {
        List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> __this__success = new ArrayList<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>(other.success.size());
    ...
    public void addToSuccess(edu.utarlington.pigeon.thrift.TTaskLaunchSpec elem) {
      if (this.success == null) {
        this.success = new ArrayList<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>();
      }
      this.success.add(elem);
    }

    public List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> getSuccess() {
      return this.success;
    }

    public getTask_result setSuccess(List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>(_list0.size);
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<edu.utarlington.pigeon.thrift.TTaskLaunchSpec>(_list5.size);
